// Script SQL oficial para inicializar la tabla en Supabase PostgreSQL
export const SUPABASE_SQL_SCHEMA = `-- =========================================================
-- Base de Datos PostgreSQL para Alquiler Mar del Tuyú
-- Tabla de Reservas, Ingresos, Egresos y Contratos
-- =========================================================
...
-- Política de lectura y escritura para la app (permite acceso anónimo / autenticado)
